...
void vulkan_render_pass_create(
    ...
    // Attachments TODO: make configurable attachments
    u32 attachment_description_count = 2;
    VkAttachmentDescription attachment_descriptions[attachment_description_count];

    // Color attachment
    VkAttachmentDescription color_attachment;
    color_attachment.format = context->swapchain.image_format.format; // TODO: configurable format
    ...
    // Render pass dependencies TODO: make configurable dependencies
...
void vulkan_render_pass_begin(
    ...
    pe_zero_memory(clear_values, sizeof(VkClearValue) * 2);
