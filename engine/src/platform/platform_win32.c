...
b8 platform_system_initialize(
    ...
    *memory_requirements = sizeof(platform_state);
    ...
    wc.lpszClassName = "PE_window_class";
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "PE_window_class", application_name,
...
void platform_console_write(const char* message, u8 colour) {
    ...
    // Outputs additionally on debug console
...
LRESULT CALLBACK win32_process_message(HWND hwnd, u32 msg, WPARAM w_param, LPARAM l_param) {
    ...
    // Call default window procedure fot the unhandled messages
